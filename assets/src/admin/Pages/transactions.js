				...
				<table className="table table-bordered border-primary transactions">
					<thead>
						<tr>
							...
							<th scope="col">
								{__('Verification Status', 'dc-bkash')}
							</th>
							<th scope="col">
								{__('Payment Time', 'dc-bkash')}
							</th>
							<th scope="col">{__('Refund', 'dc-bkash')}</th>
							<th scope="col">
								{__('Refund Amount', 'dc-bkash')}
							</th>
							<th scope="col">
								{__('Refund Charge', 'dc-bkash')}
							</th>
							<th scope="col">{__('Refund ID', 'dc-bkash')}</th>
							<th scope="col">
								{__('Refund Reason', 'dc-bkash')}
							</th>
